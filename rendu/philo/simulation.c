...
/*   Updated: 2023/05/10 10:34:50 by jgarcia          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* **************************************************************************
 * each philosopher threads starts here
 * calling the appropriate action function depending on the philosopher's
 * state if the simulation is still running
 * @param arg structures containing the philosopher's data
 ************************************************************************** */
...
/* **************************************************************************
 * initialize the philosophers' data
 * even philosophers start eating, odd ones start sleeping
 ************************************************************************** */
...
/* **************************************************************************
 * allocate memory for the philosophers and initialize the mutexes
 ************************************************************************** */
...
/* **************************************************************************
 * launch the threads and wait for them to finish then
 * clean the memory
 ************************************************************************** */
